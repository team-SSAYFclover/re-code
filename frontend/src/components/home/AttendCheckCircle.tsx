...
const AttendCheckCircle: React.FC<AttendCheckCircleProps> = ({ weekday, onoff }) => {
  function renderCircle() {
    if (onoff) {
      return (
        <div>
          <div className="rounded-full h-14 w-14 bg-MAIN1 content-center text-MAIN2 font-bold">
      ...
      return (
        <div>
          <div className="rounded-full h-14 w-14 bg-MAIN2 text-center content-center text-MAIN1 font-bold">
            {weekdays[weekday]}
          </div>
        </div>
      );
