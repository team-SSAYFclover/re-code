...
const CloverComp: React.FC<CloverCompProps> = ({ leafNum }) => {
  ...
  return (
    <>
      <div
        className="shadow-lg h-[40%] flex justify-center relative bg-white rounded-lg overflow-hidden mb-[10px]"
        data-tooltip-id="clover"
      >
      ...
      <Tooltip id="clover">
        <div className="w-84 z-20">🍀 오늘의 복습량을 늘려 네잎클로버를 채울 수 있어요 🍀</div>
      </Tooltip>
    </>
  );
};
