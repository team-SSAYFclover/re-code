...
import static com.clover.recode.global.result.error.ErrorCode.HTTP_HEADER_INVALID;
import static com.clover.recode.global.result.error.ErrorCode.HTTP_MESSAGE_NOT_READABLE;
import static com.clover.recode.global.result.error.ErrorCode.INPUT_VALUE_INVALID;
import static com.clover.recode.global.result.error.ErrorCode.INTERNAL_SERVER_ERROR;
import static com.clover.recode.global.result.error.ErrorCode.METHOD_NOT_ALLOWED;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<List<ErrorResponse.FieldError>> handleMethodArgumentNotValidException(
